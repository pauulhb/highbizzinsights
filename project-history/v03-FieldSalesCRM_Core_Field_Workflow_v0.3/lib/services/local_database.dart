...
class LocalDatabase {
  ...
  Future<Database> get database async {
    ...
    _db = await openDatabase(
      ...
      onUpgrade: (db, oldVersion, newVersion) async {
        if (oldVersion < 2) {
          await db.execute(
            'ALTER TABLE visits ADD COLUMN check_in_distance_m REAL NOT NULL DEFAULT 0'
          );
          await db.execute(
            'ALTER TABLE visits ADD COLUMN check_out_distance_m REAL NOT NULL DEFAULT 0'
          );
        }
      },
    );
  ...
  Future<void> _create(Database db, int version) async {
    await db.execute(
      ...
      'latitude REAL NOT NULL, longitude REAL NOT NULL, created_by TEXT NOT NULL, '
    ...
    await db.execute(
      ...
      'check_in_distance_m REAL NOT NULL, check_out_distance_m REAL NOT NULL, '
